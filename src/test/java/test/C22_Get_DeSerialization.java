...
public class C22_Get_DeSerialization extends baseURLDummy {
 ...
 */
    ...
    public void get01(){
        ...
        assertEquals(expdata.get("message"),expdata.get("message"));

        // expData.get("data").get("id); normalde JSON'da boyle yapiyorduk
